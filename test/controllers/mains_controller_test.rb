...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { student_id: @main.student_id, subject: @main.subject } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { student_id: @main.student_id, subject: @main.subject } }
