...
class PrefecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prefecture" do
    assert_difference("Prefecture.count") do
      post prefectures_url, params: { prefecture: { area_id: @prefecture.area_id, name: @prefecture.name } }
    end
  ...
  test "should update prefecture" do
    patch prefecture_url(@prefecture), params: { prefecture: { area_id: @prefecture.area_id, name: @prefecture.name } }
