class SchoolsController < ApplicationController
  ...
  def search_from_prefecture
    id = params[:prefecture_id]
    ret = []
    School.where(prefecture_id: id).each do |school|
      ret.push(school.hash_format)
    end
    render json: ret
  end
  ...
  private
    ...
    def school_params
      params.require(:school).permit(:name, :school_id, :prefecture_id)
    end
end
